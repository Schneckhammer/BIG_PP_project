...
int start_for_all_x = 350;
int x_original = start_for_all_x;
int start_for_all_y = 250;
int y_original = start_for_all_y;
const int parallel_portion_y = 10;
...
void* parallel_part(void* args_set){
	...
	int x_resolution = args->x_res - x_original;
	int y_resolution = args->y_res - y_original;
