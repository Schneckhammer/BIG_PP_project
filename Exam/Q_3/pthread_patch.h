...
// This is a modified version of a patch for a missing feature of PThreads on some platforms

#if (!defined _POSIX_BARRIERS || _POSIX_BARRIERS < 0) && defined(PTHREAD_SCOPE_SYSTEM)
